...
export namespace Field {
    export type ValueType<Type extends Field> = Type extends string
        ? Type
        : Type extends
              | Belongs.ManyToOne<infer Target, infer KeyType, infer Options>
        ...
        ? Options extends { nullable: true }
            ?
                  | ModelLike<Target, KeyType, true>
                  | PrimaryColumnType.ValueType<KeyType>
                  | null
            :
                  | ModelLike<Target, KeyType, false>
                  | PrimaryColumnType.ValueType<KeyType>
        : Type extends
              | Belongs.OneToOne<infer Target, infer KeyType, infer Options>
    ...
    > = Member extends "id" ? PrimaryType<T, Member> : ValueType<T[Member]>;
